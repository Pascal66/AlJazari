...
public class RoverControllerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {

    // debug / logs
    private final boolean D = false;
    private static final String TAG = RoverControllerActivity.class.getSimpleName();
