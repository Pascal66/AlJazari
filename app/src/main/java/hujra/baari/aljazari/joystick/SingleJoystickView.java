...
public class SingleJoystickView extends LinearLayout {
    @SuppressWarnings("unused")
    private static final String TAG = SingleJoystickView.class.getSimpleName();
...
//    private JoystickView stickR;
    ...
    public SingleJoystickView(Context context) {
        super(context);
...
//        stickR = new JoystickView(context);
    ...
    public SingleJoystickView(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//        stickR.setHandleColor(Color.rgb(0x20, 0x50, 0x30));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        float padW = Math.min(getMeasuredWidth(),getMeasuredHeight());
        LayoutParams joyLParams = new LayoutParams((int)padW,(int)padW);
        float Space = (getMeasuredWidth()-padW)/2;
        ViewGroup.LayoutParams padLParams = new ViewGroup.LayoutParams((int) Space,getMeasuredHeight());
