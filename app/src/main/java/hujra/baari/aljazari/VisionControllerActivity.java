...
public class VisionControllerActivity extends AppCompatActivity implements CvCameraViewListener2,SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public VisionControllerActivity() {
