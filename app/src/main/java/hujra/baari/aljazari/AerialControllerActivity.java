...
public class AerialControllerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {

    // debug / logs
    private final boolean D = false;
    private static final String TAG = AerialControllerActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aerial_controller);
